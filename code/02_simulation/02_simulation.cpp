...
int main()
{
	...
	Shader lambert = Shader(ResourcesPath() + "shaders/physics.vert", ResourcesPath() + "shaders/physics.frag");
	...
	particle1.setShader(Shader(ResourcesPath() + "shaders/solid.vert", ResourcesPath() + "shaders/solid_blue.frag"));
	
	// create demo objects (a cube and a sphere)
	Mesh sphere = Mesh::Mesh(ResourcesPath() + "models/sphere.obj");
	sphere.translate(glm::vec3(-1.0f, 1.0f, 0.0f));
	sphere.setShader(lambert);
	Mesh cube = Mesh::Mesh(ResourcesPath() + "models/cube.obj");
